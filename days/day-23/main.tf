...
resource "time_sleep" "vm_custom_data_wait" {
  # Sleep for 90 seconds to allow the VM to complete its custom data
  # script execution before exiting and printing public IP
